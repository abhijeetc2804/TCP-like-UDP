    ...
    with open(output_file_path, 'a') as file:
        while True:
            try:
                ...
                #print(33,flush=True)
                if packet_data.get("end_signal"):
                    print("Received END signal from server, file transfer complete",flush=True)
                    break
                if cnt_data_pkt<20 and packet_data.get("rtt"):
                ...
                #print(41,flush=True)
                #print("raw data:",packet_data['data'])
...
# Run the client
result = receive_file(args.server_ip, args.server_port)
